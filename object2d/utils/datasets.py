...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=416, batch_size=16, augment=False, hyp=None, rect=True, image_weights=False,
                 cache_labels=False, cache_images=False,labels = '/data1/wanglonglong/FeiYan/labels/'):
        path = str(Path(path))  # os-agnostic
        ...
        self.label_files = [ labels +  x.split('/')[-1].replace(".jpg", ".txt") for x in self.img_files]
